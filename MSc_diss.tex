...
The chemical mechanism of the model is based on recommendations from \citep{Atkinson2004} and information from the Master Chemical Mechanism, MCM v3.3 \citep{Jenkin1997,Saunders2003}, via website: http://mcm.leeds.ac.uk/MCM. (On a whole it includes 90 species and 165 reactions). The mechanism is developed to represent the chemistry that governs the production and loss of ozone, hydrocarbons and alkyl nitrates. These include:
\begin{itemize}
...
\item the loss of alkyl nitrates through their photolysis and the reaction with $OH$;
