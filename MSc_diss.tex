...
\end{itemize}
and is 'terminated' at different oxidation steps. Ethane oxidation is terminated after the formation of the acetylperoxyl radicals ($C_2H_3CO_3$), propane - after the formation of the propyldioxy radicals ($C_3H_5O_3$), n-butane - after the formation of ethanal ($CH_3CHO$), butanal ($C_3H_7CHO$), methyl ethyl ketone ($C_2H_5COCH_3$), and 1-($\lambda^1$-oxidanylmethoxy)-2-methoxy-ethane ($C_4H_9O_3$), i-butane - after the formation of 2-methylpropanal ($iso-C_3H_7CHO$) and acetone ($CH_3COCH_3$), n-pentane - after the formation of pentanal ($C_4H_9CHO$), methyl propyl ketone ($n-C_3H_7COCH_3$), and diethyl ketone ($(C_2H_5)_2CO$), i-pentane - after the formation of 2-methylbutanal ($sec-C_4H_9CHO$) and isopropyl methyl ketone ($iso-C_3H_7COCH_3$). It has been done to limit the number of reactions in the mechanism, which otherwise would include 1678 reactions describing evolution of 539 species, and therefore would be computationally too expensive. For the same reason all self-reactions of organic peroxy radicals ($RO_2$) are omitted as well. To avoid a huge impact of incomplete oxidation of alkanes on the results the model's simulation time has been restricted to 24 hours.
...
\begin{figure}[h]
\includegraphics[width=0.5\linewidth]{{./pics/Sillman1999_Fig1}.png}
%\caption{chem_allAN_netO3_rate}
\label{fig:O3observations}
\end{figure}
