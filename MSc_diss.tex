...
\end{itemize}
A more pronounced $O_3$ loss takes place under lower $VOC$ concentrations because in this case more $OH$ radicals are left in the system after oxidation of $CO$ and alkanes leading to a greater concentration of $HO_2$ radicals, and therefore to a greater chance of the last reaction in the sequence.
