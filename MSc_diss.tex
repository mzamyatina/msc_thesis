...
To estimate the impact of individual alkyl nitrates or their groups on $O_3$ production an additional series of experiments have been conducted (Figure \ref{fig:timeO3diff10ppbNOx6VOC}).
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{table}
\caption{Difference in $O_3$ mixing ratio by the end of simulation depending alkyl nitrate chemistry.}\label{tab:timeO3diff10ppbNOx6VOC}
\begin{tabular}{cc}
\hline
Alkyl nitrate            & $O_3$ difference (ppb) \\
\hline
$CH_3ONO_2$              & -11.5 \\
$C_2H_5ONO_2$            & -11.6 \\
$\Sigma C_3H7ONO_2$      & -10.5 \\
$\Sigma nC_4H_9ONO_2$    & -8.7  \\
$\Sigma iC_4H_9ONO_2$    & -11.0 \\
$\Sigma nC_5H_{11}ONO_2$ & -10.1 \\
$\Sigma iC_5H_{11}ONO_2$ & -8.0  \\
$\Sigma RONO_2$          & -11.9 \\
\hline
\end{tabular}
\end{table}
